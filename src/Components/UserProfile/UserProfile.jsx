...
import { followAndUnfollowUser, getUserPosts, getUserProfile } from '../../Redux/Actions/User';
...
const UserProfile = () => {
    ...
    }, [user, me._id, params.id, dispatch]);
                ...
                {user && (
                    <>
                        ...
                        {myProfile ? null : (
                            <Button
                                variant="contained"
                                style={{ background: following ? "#ff4685" : "#2196f3" }}
