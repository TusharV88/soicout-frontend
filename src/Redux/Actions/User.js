...
export const loadUser = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${server}/api/v1/profile`, { withCredentials: true });
...
export const deleteMyProfile = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.delete(`${server}/api/v1/delete/profile`, { withCredentials: true });
...
export const getUserPosts = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${server}/api/v1/posts/${id}`, { withCredentials: true });
        dispatch({
